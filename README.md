...
Welcome to DockerRoot version 1.2.12, Docker version 1.9.1, build 66c06d0-stripped
[docker@docker-root ~]$ 
```
...
Operating System: DockerRoot v1.2.12
CPUs: 1
...
Debug mode (server): true
 File Descriptors: 12
 Goroutines: 18
 System Time: 2016-02-17T15:27:21.543946227Z
 EventsListeners: 0
 Init SHA1:
